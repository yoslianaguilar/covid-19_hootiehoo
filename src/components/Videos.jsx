...
export const Videos = () => {
    return (
        <div>
            <h1>Conoce y sigue las aventuas de Puma Espuma y el Escuadrón Prevención </h1>
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/zcG4TeFRSBA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
